...
It is important that the columns on your input file are directly listed in the following file: /template_file_info/datapoint_cell_locations.csv. The column headers from your input file are listed here as a 'datapoint'. 
